...
public class SerachServerAdapter  extends ArrayAdapter<String> {
	Context context;
	...
	public SerachServerAdapter(Context context,	ArrayList<String> nameal, ArrayList<String> rollal,ArrayList<String> classnameal,
	ArrayList<String> subjectal, ArrayList<String> semisteral, ArrayList<String> totallectal, ArrayList<String> totalattal,
	ArrayList<String> remarksal, ArrayList<String> prratingal, ArrayList<String> brratingal, ArrayList<String> teachernameal,ArrayList<String> updatedateal) {
		super(context,R.layout.serversearchrow,nameal);
	 ...
	 public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    convertView = inflater.inflate(R.layout.serversearchrow, parent, false); 
		...
		brating=Float.parseFloat(brratingal.get(position));}
		 ...
		 classname .setText("Classname : " +classnameal.get(position));
